/* ═══════════════════════════════════════════════════════════════════════════
   icons.js — set de iconos Lucide inline (los mismos que usa App.tsx).
   Se incrustan como SVG para no depender de ningún paquete ni CDN.
   ═══════════════════════════════════════════════════════════════════════════ */
...
/** Reemplaza todo <span data-icon="..." data-size="..."> por su SVG. */
