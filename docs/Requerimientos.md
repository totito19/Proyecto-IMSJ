...
| RF8 | El sistema debe permitir gestionar el estado de una noticia ej: como publicada o no-publicada. |
...
| RNF8 | Separación clara entre contenidos publicados y contenidos no-publicados |
